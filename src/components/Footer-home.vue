<template> 
    <footer class="main-footer mt-5">
        ...
        <img  :src="imageUrls.logoCty" />
      </a></figure>
                            <div class="text">
                                <p>Cam kết mang đến sản phẩm chất lượng, giúp bạn tiếp cận khách hàng hiệu quả và nâng tầm thương hiệu trong thời đại số.</p>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 offset-lg-2 footer-column">
                        <div class="service-widget footer-widget">
                            <div class="footer-title">Thiết kế Website</div>
                            <ul class="list">
                                <li><a href="#">Website theo yêu cầu</a></li>
                                <li><a href="#">Website doanh nghiệp</a></li>
                                <li><a href="#">Website bán hàng, quản lý</a></li>
                                <li><a href="#">Project cá nhân</a></li>
                                <li><a href="#">Website bất động sản</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 footer-widget">
                        <div class="contact-widget footer-widget">
                            <div class="footer-title">CLiên hệ</div>
                            <div class="text">
                                <p>(+84)979951954</p>
                                <p>ivienchelsea325@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
